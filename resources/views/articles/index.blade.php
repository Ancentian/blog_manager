    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                    <div class="blog grid-blog flex-fill">
                        <div class="blog-image">
                            <a href="blog-details.html"><img class="img-fluid" src="{{asset('assets/img/category/blog-6.jpg')}}" alt="Post Image"></a>
            ...
            <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                <div class="blog grid-blog flex-fill">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid" src="{{asset('assets/img/category/blog-2.jpg')}}" alt="Post Image"></a>
                        <div class="blog-views">
            ...
            <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                <div class="blog grid-blog flex-fill">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid" src="{{asset('assets/img/category/blog-3.jpg')}}" alt="Post Image"></a>
                        <div class="blog-views">
            ...
            <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                <div class="blog grid-blog flex-fill">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid" src="{{asset('assets/img/category/blog-5.jpg" alt="Post Image')}}"></a>
                        <div class="blog-views">
                    ...
                    <div class="blog-content">
                        <ul class="entry-meta meta-item">
                            <li>
                                <div class="post-author">
                                    <a href="profile.html">
                                        <img src="{{asset('assets/img/profiles/avatar-05.jpg')}}" alt="Post Author">
                                        <span>
